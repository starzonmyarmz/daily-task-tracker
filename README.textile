...
As mentioned earlier, the BETT(Browser Emergent Task Timer) uses HTML and Javascript. It also uses the "jQuery":http://jquery.com Javascript library, a lot of CSS3 features and attributes, and uses no images (despite there being an _images_ directory).